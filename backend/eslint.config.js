...
module.exports = [
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      // ReportController, ReviewController, GroupChatController and the
      // since-deleted ServiceController each had one, so filing a report,
      // listing a service, resolving a pet's owner and finding a group chat
      // all threw.
